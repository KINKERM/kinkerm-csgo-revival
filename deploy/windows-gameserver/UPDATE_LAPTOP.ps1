...
if (-not $installedItemsText.Contains("REVIVAL_COVERT_TRADEUP_SCHEMA_V4_LEGACY")) {
    throw "Installed laptop items_game.txt is stale; missing REVIVAL_COVERT_TRADEUP_SCHEMA_V4_LEGACY"
}
Write-Host "    Verified launch-safe Legacy 5-Covert recipes." -ForegroundColor Green
...
Write-Host "    Verified current V33 Competitive/match-result laptop agent." -ForegroundColor Green
