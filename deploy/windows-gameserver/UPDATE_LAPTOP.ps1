...
if (-not $agentText.Contains("REVIVAL_AGENT_MATCH_FINAL_V23")) {
    throw "Downloaded laptop agent is stale; missing REVIVAL_AGENT_MATCH_FINAL_V23"
}
Write-Host "    Verified current V23 Competitive/match-result laptop agent." -ForegroundColor Green
