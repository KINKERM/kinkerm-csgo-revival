...
if (-not $agentText.Contains("REVIVAL_AGENT_MATCH_FINAL_V31")) {
    throw "Downloaded laptop agent is stale; missing REVIVAL_AGENT_MATCH_FINAL_V31"
}
Write-Host "    Verified current V31 Competitive/match-result laptop agent." -ForegroundColor Green
