...
if (-not $agentText.Contains("REVIVAL_AGENT_MATCH_FINAL_V30")) {
    throw "Downloaded laptop agent is stale; missing REVIVAL_AGENT_MATCH_FINAL_V30"
}
Write-Host "    Verified current V30 Competitive/match-result laptop agent." -ForegroundColor Green
