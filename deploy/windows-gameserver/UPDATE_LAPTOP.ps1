...
if (-not $agentText.Contains("REVIVAL_AGENT_MATCH_FINAL_V26")) {
    throw "Downloaded laptop agent is stale; missing REVIVAL_AGENT_MATCH_FINAL_V26"
}
Write-Host "    Verified current V26 Competitive/match-result laptop agent." -ForegroundColor Green
