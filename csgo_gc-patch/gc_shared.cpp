    ...
    {
        {
            ...
            // Wake periodically as well as on events. ClientGC uses the idle
            // tick to poll the local launcher matchmaking bridge.
            m_cv.wait_for(lock, std::chrono::milliseconds(250), [this]
