...
var OperationStoreInspect = ( function()
{
	...
	var _UpdateCheerBtn = function( elPlayerModel, settings )
	{
		...
		else
		{
			...
			elCheerBtn.SetPanelEvent( 'onactivate', function(){
				...
				settings.activity = "ACT_CSGO_UIPLAYER_CELEBRATE";
	...
	var _SetUpWeaponCaseModel = function()
	{
		...
		$.DispatchEvent( "PlaySoundEffect", "container_" + 'weapon_fall', "MOUSE" );
	...
	var MakeThumbnailImageForTray = function( elParent, rewardId )
	{
		...
		if( rewardId === '0' )
		{
			...
			elImage.SetImage( "file://{images_econ}/" + unusualItemImagePath );
		}
		else
		{
	...
	{
		MissionsAPI.ActionRedeemOperationGoods( 10, _m_rewardIndex );
